...
#if !defined(MIRYOKU_LAYER_ISAAC)
  #if defined (MIRYOKU_LAYERS_FLIP)
    #define MIRYOKU_LAYER_ISAAC MIRYOKU_ALTERNATIVES_ISAAC_FLIP
  #else
    #define MIRYOKU_LAYER_ISAAC MIRYOKU_ALTERNATIVES_ISAAC
  #endif
#endif
#if !defined(MIRYOKU_LAYERMAPPING_ISAAC)
  #define MIRYOKU_LAYERMAPPING_ISAAC MIRYOKU_MAPPING
#endif
