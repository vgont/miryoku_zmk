...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      &tog U_ISAAC,              U_RGB_TOG,         U_RGB_EFF,         U_RGB_HUI,         U_RGB_SAI,         U_RGB_BRI,         \
...
&kp LCTRL,  &kp Q,     &kp W,     &kp E,     &kp R,     U_NA,     U_NA,     &kp UP,     U_NA,     &tog U_ISAAC, \
